...
import fr.eisti.optimEisti_RaLiGaKl.controler.problemes.FileChooserListener;
...
/**
 * Classe qui permet de créer le panel pour créer un utilisateur
 * @author Razavet Maël, Lion Cédric, Klelifa Sarah, Gallet Meriadec
 */
public class JPanelFondCreerCompte extends JPanel {
    ...
    public JPanelFondCreerCompte(Image image) {
        ...
        this.jtfAvatar = new JTextField(40);
